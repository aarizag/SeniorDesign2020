...
from load_excel import UNSPSC_SLIM, COMM
from compare_excels import compare_from_row

FILE_NAME = "UNSPSC_randSample.xls"
...
def assign_best_to_rows():
    all_rows = []
    UNSPSC_SLIM.set_workbook()
    fields = UNSPSC_SLIM.fields
    ...
    count = 0
    for row in UNSPSC_SLIM.get_all_rows():
        if count % 100 == 0:
